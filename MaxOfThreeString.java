package com.BridgeLabz_Day13Assignment;
...
public class MaxOfThreeString {
	public static String maxOfThreeName(String name1,String name2, String name3){
		...
		Integer num2=(Integer)name1.length();
		Integer num3=(Integer)name1.length();
	...
	public static void main(String []args){
		System.out.println("Find maximum among three Names.");
		...
		System.out.println("The three largest numbers is: "+ maxName);
	}
}
